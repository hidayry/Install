...
#Run pacman
sudo pacman -S xfce4 xfce4-goodies lightdm lightdm-slick-greeter pulseaudio pulseaudio-alsa pulseaudio-jack libcanberra pavucontrol firefox gvfs gvfs-mtp gvfs-ntfs || { echo "Error: Failed to install"; exit 1; }
...
# Run yay
yay -S lightdm-settings || { echo "Error: Failed to install lightdm-settings"; exit 1; }
